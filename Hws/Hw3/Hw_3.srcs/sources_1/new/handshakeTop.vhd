...
architecture Behavioral of handshakeTop is
   ...
   port ( 
    ...
    signal hybrid_internal_data : std_logic_vector(7 downto 0);
...
begin
    ...
    cons : consumer port map (
        ...
        i_req => req_o,
        o_ack => ack_i,
        i_data => hybrid_internal_data,  
        o_recv => o_recv,
        o_data => o_data
    );
    
    hybrid: TwoWayHandshake port map (
        i_clk => i_clk,
        i_rst => i_rst,
        i_req => req,
        o_ack => ack,
