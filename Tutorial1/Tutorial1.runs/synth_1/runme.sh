...
HD_PWD='C:/Users/diego/Documents/Reconfig/Tutorial1/Tutorial1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XilinxIntro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XilinxIntro.tcl
